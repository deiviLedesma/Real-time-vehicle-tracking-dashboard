 ...
 * @author Ángel
 */
public class frmGerenciaCongestiones extends javax.swing.JFrame {
     ...
     */
    public frmGerenciaCongestiones() {
        initComponents();
    ...
    private String llamarEndpoint(String token) throws Exception {
        String url = "http://" + txtHost.getText() + "/api/reportes/congestiones";
    ...
    private void initComponents() {
        ...
        setTitle("Gerencia Congestiones — MVTS");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGerenciaCongestiones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmGerenciaCongestiones().setVisible(true);
            }
        });
    }
